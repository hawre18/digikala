...
<head>
    ...
    <link rel="stylesheet" href="/assets/User/vendor/fontawesome/font-awesome.min.css">
    <link rel="stylesheet" href="/assets/User/vendor/swiper/css/swiper.min.css">
    <link rel="stylesheet" href="/assets/User/vendor/slicknav/slicknav.min.css">
    <link rel="stylesheet" href="/assets/User/css/main.css">
    <link rel="stylesheet" href="/assets/User/css/mediaq.css">
</head>

<body>
<header class="shipping">
    <div class="logo container">
        <a href="#"><img src="/assets/User/images/logo.svg"></a>
    </div>
</header>
<style>
...
<section class="c-checkout-alert container">
    ...
    <div class="c-checkout-alert__title">
        <h4>سفارش <span class="c-checkout-alert__highlighted c-checkout-alert__highlighted--success">DKC-39637837</span> با موفقیت در سیستم ثبت شد.</h4></div>
...
<section class="c-checkout-details container">
    ...
    <div class="c-checkout-details__row">
        <div class="c-checkout-details__col--text">
            <p>سفارش شما با موفقیت در سیستم ثبت شد و هم اکنون <span class="text-highlight text-highlight--ok">تکمیل شده</span> است. جزئیات این سفارش را می‌توانید با کلیک بر روی دکمه <a href="#" class="btn-link-spoiler">پیگیری سفارش</a> مشاهده نمایید.</p>
        </div> <a href="#" class="btn-order-traking">پیگیری سفارش</a></div>
    <div class="c-checkout-details__row">
        <div class="c-checkout-details__col--table">
            <div class="c-checkout-table">
                <div class="c-checkout-table__row">
                    ...
                    <div class="c-checkout-table__col"><span>شماره تماس : ۰۹۱۲۶۲۶۲۶۲۶</span></div>
                </div>
                <div class="c-checkout-table__row">
                ...
                <div class="c-checkout-table__row">
                    <div class="c-checkout-table__col full-col"><span>آدرس : استان تهران ، شهر تهران، سایت نت پارادیس</span></div>
                </div>
            </div>
        </div>
    </div>
...
<footer>
    <section class="footer container">
        <div class="icon">
            <div class="icon-item">
                <a href="#"> <img src="/assets/User/images/icon/1.svg" alt=""> <span>7 روز ضمانت بازگشت</span> </a>
            </div>
            <div class="icon-item">
                <a href="#"> <img src="/assets/User/images/icon/2.svg" alt=""> <span>پرداخت در محل</span> </a>
            </div>
            <div class="icon-item">
                <a href="#"> <img src="/assets/User/images/icon/4.svg" alt=""> <span>تحویل اکسپرس</span> </a>
            </div>
            <div class="icon-item">
                <a href="#"> <img src="/assets/User/images/icon/3.svg" alt=""> <span>پشتیبانی ۲۴ ساعته</span> </a>
            </div>
            <div class="icon-item">
                <a href="#"> <img src="/assets/User/images/icon/5.svg" alt=""> <span>ضمانت اصل بودن کالا</span> </a>
            </div>
        </div>
        <div class="footer-content">
            ...
            <div class="cert">
                ...
                <div class="image"> <img src="/assets/User/images/cert/enamad.png" alt=""> <img src="/assets/User/images/cert/samandehi.png" alt=""></div>
            </div>
        </div>
        <div class="footer-contact">
            ...
            <div class="app"> <img src="/assets/User/images/bazar.png" alt=""> <img src="/assets/User/images/sibapp.png" alt=""></div>
        </div>
        <div class="copyright">
...
<script src="/assets/User/vendor/swiper/js/swiper.min.js"></script>
<script src="/assets/User/vendor/slicknav/jquery.slicknav.min.js"></script>
<script src="/assets/User/vendor/jquery.countdown.min.js"></script>
<script src="/assets/User/vendor/persianumber.min.js"></script>
<script src="/assets/User/vendor/elevatezoom.js"></script>
