                ...
                <li>
                    ...
                    <div class="c-checkout-paymethod__options">
                        <div class="c-checkout-paymethod__providers">
                            ...
                            <label> <span class="c-ui-radio"> <input type="radio" cheked name="bank_id"> <span class="c-ui-radio__check"></span> </span> <span class="c-checkout-paymethod__source-title">بانک سامان</span> <img src="/assets/User/images/samanbank.png" alt=""> </label>
                            <label class="is-selected"> <span class="c-ui-radio"> <input type="radio" cheked name="bank_id"> <span class="c-ui-radio__check"></span> </span> <span class="c-checkout-paymethod__source-title">بانک ملت</span> <img src="/assets/User/images/dpay.png" alt=""> </label>
                        </div>
                    </div>
                </li>
            </ul>
            ...
            <div class="c-checkout-order-summary">
                <section class="c-checkout-order-summary__item">
                    ...
                    <div class="c-checkout-order-summary__content">
                        <div class="c-product-box"> <img src="/assets/User/images/257887.jpg" alt="">
            ...
            <div class="c-checkout-price-options">
                <div class="c-checkout-price-options__form">
                    <section class="c-checkout-price-options__container">
                        <div class="c-checkout-price-options__header"> <span>استفاده از کد تخفیف تک‌کالا</span></div>
        ...
        <div class="c-checkout-aside">
            <div class="c-checkout-summary">
                <ul class="c-checkout-summary__summary">
                    ...
                    <li class="pd-10">
                        <span> <i class="fa fa-money"></i> امتیاز تک کلاب</span>
                        <span> ۲۰ امتیاز </span>
                    </li>
                </ul>
            </div>
...
<footer>
    <section class="footer container">
        ...
        <div class="copyright">
            <p>استفاده از مطالب فروشگاه اینترنتی تک‌کالا فقط برای مقاصد غیرتجاری و با ذکر منبع بلامانع است. کلیه حقوق این سایت متعلق به شرکت فلان می‌باشد.</p>
        </div>
    </section>
</footer>
