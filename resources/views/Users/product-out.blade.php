...
<div class="container">
    <nav>
        <ul class="c-breadcrumb">
            <li class="list-item"><a href="#">فروشگاه اینترنتی تک‌کالا</a></li>
            <li class="list-item"><a href="#">کالای تکتال</a></li>
            <li class="list-item"><a href="#">موبایل</a></li>
            <li class="list-item"><a href="#">گوشی موبایل</a></li>
            <li class="list-item"><a href="#"> تبلت سامسونگ مدل GALAXY TAB S6 ظرفیت 128 گیگابایت </a></li>
        </ul>
    </nav>
    <article class="c-product">
        <section class="c-product__info">
            <div class="c-product__headline">
                <h1 class="c-product__title"> <span class="fa-title"> تبلت سامسونگ مدل GALAXY TAB S6 ظرفیت 128 گیگابایت </span> <span class="en-title">Samsung GALAXY TAB S6 Tablet 128 GB</span></h1> <span class="c-product__guaranteed">بیش از ۱۰ نفر از خریداران این محصول را پیشنهاد داده‌اند</span></div>
            <div class="c-product__attributes">
                <div class="c-product__config hidden">
                    <div class="c-product__directory">
                        <ul>
                            <li> <span>برند : </span> <a href="#" class="btn-link-spoiler">سامسونگ</a></li>
                            <li> <span>دسته بندی : </span> <a href="#" class="btn-link-spoiler">تبلت و کتابخوان</a></li>
                        </ul>
                    </div>
                    <div class="c-product__variants"> <span>رنگ : </span>
                        <ul>
                            <li>
                                <label> <span></span>
                                    <input type="radio"> <span>قرمز</span> </label>
                            </li>
                        </ul>
                    </div>
                    <div class="c-product__guarantee"> <span>گارانتی ۱۸ ماهه داتیس امارات</span></div>
                    <div class="c-product__delivery">
                        <div class="seller"> <span> فروشنده</span> <a href="#" class="btn-link-spoiler">تک کالا</a></div>
                        <div class="delivery-warehouse"> <span>ارسال از ۱ روز آینده</span></div>
                    </div>
                    <div class="c-price original">۲,۶۶۹,۰۰۰ تومان</div>
                    <div class="c-product__add"> <a class="btn-add-to-cart" href="#"><span>افزودن به سبد خرید</span></a>
                        <div class="c-product__unfair-price"> <span>آیا از قیمت راضی هستید؟ </span> <a class="btn-link-spoiler" href="#">بله</a> | <a class="btn-link-spoiler" href="#">خیر</a></div>
                    </div>
                </div>
                <section class="out-stock">
                    <div class="c-message c-message--info">متاسفانه این کالا در حال حاضر موجود نیست. می‌توانید از طریق لیست بالای صفحه، از محصولات مشابه این کالا دیدن نمایید</div>
                    <div class="c-product__add">
                        <button class="btn-notify-me ">موجود شد به من اطلاع بده</button>
                    </div>
                </section>
            </div>
            <aside class="c-product__feature">
                <a class="i-item" href="#"> <img src="/assets/User/images/icon/i1.svg" alt=""> <span>امکان تحویل اکسپرس</span> </a>
                <a class="i-item" href="#"> <img src="/assets/User/images/icon/i2.svg" alt=""> <span>پشتیبانی ۲۴ ساعته</span> </a>
                <a class="i-item" href="#"> <img src="/assets/User/images/icon/i3.svg" alt=""> <span>امکان پرداخت در محل</span> </a>
                <a class="i-item" href="#"> <img src="/assets/User/images/icon/i4.svg" alt=""> <span>۷ روز ضمانت بازگشت کالا</span> </a>
                <a class="i-item" href="#"> <img src="/assets/User/images/icon/i5.svg" alt=""> <span>ضمانت اصل بودن کالا</span> </a>
            </aside>
        </section>
        <section class="c-product__gallery">
            ...
            <!--<div class="c-product__status-bar c-product__status-bar--out-of-stock">ناموجود</div>-->
            <div class="c-gallery">
                <div class="c-gallery__item">
                    ...
                    <div class="c-gallery__img"> <img src="/assets/User/images/119350700.jpg" class="xzoom" alt=""></div>
                </div>
                <ul class="c-gallery__items">
                    <li><img src="/assets/User/images/119350700.jpg" alt=""></li>
                    <li><img src="/assets/User/images/119350696.jpg" alt=""></li>
                    <li><img src="/assets/User/images/119350706.jpg" alt=""></li>
                    <li><img src="/assets/User/images/119350704.jpg" alt=""></li>
                </ul>
            </div>
        </section>
    </article>
    <section class="p-tabs">
        ...
        <div class="c-box--tabs p-tabs__content">
            ...
            <div id="comments">
                ...
                <div class="c-comments__summary">
                    ...
                    <div class="c-comments__summary-note"> <span>شما هم می‌توانید در مورد این کالا نظر بدهید.</span>
                        <p>برای ثبت نظر، لازم است ابتدا وارد حساب کاربری خود شوید. اگر این محصول را قبلا از تک‌کالا خریده باشید، نظر شما به عنوان مالک محصول ثبت خواهد شد.</p> <a href="#" class="btn-add-comment is-disabled"><span>افزودن نظر جدید</span></a></div>
                </div>
            ...
            <div class="article">
                ...
                <p>گوشی از نظرظاهری خوبه باطریش زود شارژ خالی میکنه کیفیت عکس در شب و نور کم اصلن خوب نیست ولی در روز خوبه در مقایسه با j7 prime 2 2018 گوشی الفون بازنده واقعی هست تنها برتری اون تو رم 6گیگ و حافظه داخلی 64هست</p>
                <div class="footer">
        ...
        <div class="form-row">
            ...
            <div class="agreement">
                ...
                <label for="agree"> اولین پاسخی که به پرسش من داده شد، از طریق ایمیل به من اطلاع دهید.
                    <br> با انتخاب دکمه “ثبت پرسش”، موافقت خود را با قوانین انتشار محتوا در تک کالا اعلام می کنم. </label>
            </div>
        </div>
    </form>
    <div class="c-comments__filter">
        ...
        <ul class="c-faq__list">
                        ...
                        <div class="c-faq__answer-col c-faq__answer-col--form"> <span class="h3">به این سوال پاسخ دهید</span>
                            <form action="#">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="agreement">
                                        <input id="agree" type="checkbox">
                                        <label for="agree">با انتخاب دکمه "ثبت پاسخ"، موافقت خود را با قوانین انتشار محتوا در تک‌کالا اعلام می‌کنم.</label>
                                    </div>
                                </div>
                            </form>
                        </div>
            ...
            <li class="is-answer">
                <div class="section">
                    ...
                    <p>سلام گوشی نو هستش برادر میتونی بعد خرید مالکیت بزنی هیچ مشکلی نداره.. دسته دوم نیس که بگی رجیستر هس یا نه. شما از یه فروشگاه معتبر تک کالا خرید میکنی.</p>
...
<section class="product-wrapper container">
    ...
    <div id="mvpslider" class="swiper-container">
        <div class="product-box swiper-wrapper">
            <div class="product-item swiper-slide">
        ...
        <div id="mvpslider-nbtn" class="slider-nbtn swiper-button-next"></div>
        <div id="mvpslider-pbtn" class="slider-pbtn swiper-button-prev"></div>
    </div>
</section>
</div>
