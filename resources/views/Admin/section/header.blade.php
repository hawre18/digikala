                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="hidden-xs">حسن شفیعی</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active treeview">
                    <a href="#">
                        <i class="fa fa-dashboard"></i> <span>استان</span>
                        <span class="pull-left-container">
                            <i class="fa fa-angle-right pull-left"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li class="active"><a href="/admin/province"><i class="fa fa-circle-o"></i>استان</a></li>
                        <li><a href="/admin/city"><i class="fa fa-circle-o"></i>شهرستان ها</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
